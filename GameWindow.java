...
public class GameWindow extends JFrame implements ActionListener 
{
	...
	public GameWindow()
	{
      ...
      z = new JButton("Z");
	   ...
	   //add Listeners: (REGISTER OF ACTION EVENT)
		  ...
		  public void actionPerformed(ActionEvent ae)
		  {
			 ...
			 for(int loop=0;loop<len;loop++)
			 {
			   if(letter.charAt(0)== word[rnd].charAt(loop))
			   {
				 ...
				 // here we have use loop*2 because
		         // in blanks.append("_ ") we have given one spacde if we have given 2 spaces then loop*3 will be witten:
				 count++;
		       }
			 }
			 if(flag==1)
			 ...
			 if(count==len)
			 {
			    JOptionPane.showMessageDialog(this,"Congrats You Guessed The Wors Correctly");
				int n= JOptionPane.showConfirmDialog(this,"Do You Want To The Play The Game Again?","Restart The Game", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
